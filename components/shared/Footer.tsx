      ...
      <div className="max-w-7xl mx-auto py-8 md:py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div className="sm:col-span-2 md:col-span-1">
            <h3 className="text-lg font-bold mb-4">BFL<span className="text-yellow-400">.pk</span></h3>
            <p className="text-gray-300 text-sm md:text-base">
              Connecting students with educational consultants for successful study abroad journeys.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/universities" className="text-gray-300 hover:text-white text-sm">Universities</Link></li>
              <li><Link href="/consultants" className="text-gray-300 hover:text-white text-sm">Consultants</Link></li>
              <li><Link href="/scholarships" className="text-gray-300 hover:text-white text-sm">Scholarships</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-8 border-t border-blue-800 pt-6 md:pt-8 md:flex md:items-center md:justify-between">
          <div className="flex space-x-4 md:order-2 mb-4 md:mb-0">
          ...
          <p className="text-xs md:text-base text-gray-400 md:mt-0 md:order-1">
            &copy; 2025 BFL.pk. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
