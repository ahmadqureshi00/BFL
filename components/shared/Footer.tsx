        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/consultants" className="text-gray-300 hover:text-white">Consultants</Link></li>
              <li><Link href="/scholarships" className="text-gray-300 hover:text-white">Scholarships</Link></li>
            </ul>
          </div>
